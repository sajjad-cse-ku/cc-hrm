    ...
    <AdminLayout>
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-semibold text-gray-900">Create Document Type</h1>
            <p className="text-sm text-gray-600 mt-1">
              Add a new document type to your organization.
            </p>
          </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Fill in the document type details below.</CardDescription>
          </CardHeader>
          <CardContent>
